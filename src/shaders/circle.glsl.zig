...
//
//    Cmdline:
//        sokol-shdc -i ./src/shaders/circle.glsl -o ./src/shaders/circle.glsl.zig -l glsl410:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig
//
//    Overview:
//    =========
//    Shader program: 'circle':
//        Get shader desc: shd.circleShaderDesc(sg.queryBackend());
//        Vertex shader: vs
//            Attributes:
//                ATTR_vs_position => 0
//                ATTR_vs_color0 => 1
...
const fs_source_wgsl = [489]u8 {
    ...
    0x3d,0x20,0x78,0x5f,0x31,0x32,0x3b,0x0a,0x20,0x20,0x72,0x65,0x74,0x75,0x72,0x6e,
...
pub fn circleShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    var desc: sg.ShaderDesc = .{};
    desc.label = "circle_shader";
    switch (backend) {
        .GLCORE => {
